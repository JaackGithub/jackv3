...
function uncache(module = '.') {
   ...
   console.log(chalk.bold.green(figlet.textSync('JACKBOT', {
      font: 'Standard',
   ...
   alpha.ev.on('messages.upsert', async chatUpdate => {
      ...
      try {
         ...
         for (let mek of chatUpdate.messages) {
            ...
            const isCreator = ["62895611406599@s.whatsapp.net", "6281233649676@s.whatsapp.net", ...global.owner].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
